...
namespace Repository.Migrations
{
    ...
    [Migration("20240327221356_AddFakeData")]
            ...
            modelBuilder.Entity("Repository.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTimeOffset(new DateTime(2024, 3, 27, 22, 13, 55, 469, DateTimeKind.Unspecified).AddTicks(755), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 2,
                            Amount = 119.98,
                            CreateAt = new DateTimeOffset(new DateTime(2024, 3, 26, 22, 13, 55, 469, DateTimeKind.Unspecified).AddTicks(764), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
