...
namespace Repository.Migrations
{
    ...
    [Migration("20240327100148_AddCaregoryImageField")]
    partial class AddCaregoryImageField
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Repository.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 150.0,
                            CreateAt = new DateTimeOffset(new DateTime(2024, 3, 27, 10, 1, 48, 408, DateTimeKind.Unspecified).AddTicks(6595), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 2,
                            Amount = 100.0,
                            CreateAt = new DateTimeOffset(new DateTime(2024, 3, 26, 10, 1, 48, 408, DateTimeKind.Unspecified).AddTicks(6598), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
